...
OnRtnRepealFromBankToFutureByFuture = 'OnRtnRepealFromBankToFutureByFuture'
...
OnRtnRepealFromFutureToBankByFutureManual = 'OnRtnRepealFromFutureToBankByFutureManual'
OnRtnFromBankToFutureByFuture = 'OnRtnFromBankToFutureByFuture'
OnRtnFromFutureToBankByBank = 'OnRtnFromFutureToBankByBank'
OnRtnRepealFromBankToFutureByFutureManual = 'OnRtnRepealFromBankToFutureByFutureManual'
...
OnRtnRepealFromFutureToBankByFuture = 'OnRtnRepealFromFutureToBankByFuture'
...
#       所有onErrRtn开头方法      #
###################################
OnErrRtnRepealFutureToBankByFutureManual = 'OnErrRtnRepealFutureToBankByFutureManual'
OnErrRtnFutureToBankByFuture = 'OnErrRtnFutureToBankByFuture'
OnErrRtnOrderInsert = 'OnErrRtnOrderInsert'
OnErrRtnRepealBankToFutureByFutureManual = 'OnErrRtnRepealBankToFutureByFutureManual'
